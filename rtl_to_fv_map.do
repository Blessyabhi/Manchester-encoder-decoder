...
# Generated on: Sat Nov 01 14:10:28 IST 2025 (Sat Nov 01 08:40:28 UTC 2025)
...
set_log_file fv/top_manchester/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/top_manchester -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  manchester_encoder.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  manchester_decoder.v
add_search_path . -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  top_manchester.v
elaborate_design -golden -root {top_manchester} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/top_manchester/fv_map.v.gz
elaborate_design -revised -root {top_manchester}
...
#add_name_alias fv/top_manchester/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/top_manchester/rtl_to_fv_map.log
}
